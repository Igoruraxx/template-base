            ...
            <div className="mb-6 space-y-4">
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast({
                      title: "Erro",
                      description: err.message || "Algo deu errado ao conectar com o Google.",
                      variant: "destructive",
                    });
                  } finally {
                    setIsLoading(false);
                ...
                disabled={isLoading}
                className="w-full h-12 rounded-xl flex items-center justify-center gap-2 font-medium bg-background hover:bg-muted/50 border-border"
              >
              ...
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <span className="w-full border-t border-muted/70" />
                </div>
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#ffffff] dark:bg-[#1f2937] px-2 text-muted-foreground/70 rounded-md">ou continue com e-mail</span>
                </div>
              </div>
            </div>
          )}
